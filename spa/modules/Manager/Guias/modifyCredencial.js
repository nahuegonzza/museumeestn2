class modifyCredencial{
    ...
    children = [ {type:"form", props:{class: "form manager"}, children:[
        {type: "h1", props:{style:"font-size:36px;"}, children:["Modificar Credencial"]},
        
        {type: "h7", children:["Lista de Credenciales para modificar una"]},
