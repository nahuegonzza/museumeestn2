class deleteGuias{
    ...
    children = [ {type:"form", props:{class: "form manager"}, children:[
        {type: "h1", props:{style:"font-size:36px;"}, children:["Deshabilitar/Habilitar Guias"]},
        
        {type: "h7", children:["(Lista de Guias con tickeo para seleccionar una o deseleccionarla)"]},
